...
enum Square : uint8_t {
	...
	SQ_A1, SQ_B1, SQ_C1, SQ_D1, SQ_E1, SQ_F1, SQ_G1, SQ_H1, SQ_TOTAL, SQ_NULL
};
...
constexpr auto char_to_piece(const char c) {
    switch (c) {
        case 'P': return make_piece(PT_PAWN, CLR_WHITE);
        case 'N': return make_piece(PT_KNIGHT, CLR_WHITE);
        case 'B': return make_piece(PT_BISHOP, CLR_WHITE);
        case 'R': return make_piece(PT_ROOK, CLR_WHITE);
        case 'Q': return make_piece(PT_QUEEN, CLR_WHITE);
        case 'K': return make_piece(PT_KING, CLR_WHITE);
        case 'p': return make_piece(PT_PAWN, CLR_BLACK);
        case 'n': return make_piece(PT_KNIGHT, CLR_BLACK);
        case 'b': return make_piece(PT_BISHOP, CLR_BLACK);
        case 'r': return make_piece(PT_ROOK, CLR_BLACK);
        case 'q': return make_piece(PT_QUEEN, CLR_BLACK);
        case 'k': return make_piece(PT_KING, CLR_BLACK);
        default:  break;
    }
...
constexpr auto piece_to_char(const Piece pce) {
    switch (pce) {
        case PCE_WPAWN:  return 'P';
        case PCE_WKNIGHT:return 'N';
        case PCE_WBISHOP:return 'B';
        case PCE_WROOK:  return 'R';
        case PCE_WQUEEN: return 'Q';
        case PCE_WKING:  return 'K';
        case PCE_BPAWN:  return 'p';
        case PCE_BKNIGHT:return 'n';
        case PCE_BBISHOP:return 'b';
        case PCE_BROOK:  return 'r';
        case PCE_BQUEEN: return 'q';
        case PCE_BKING:  return 'k';
        case PCE_NULL : return '.';
        default:         break;
    }
